...
void init_ss()
{
    ...
    A0 = 1, 0.000104778166629036, 0.000155226913524498, 0, 0,
    0, 3.58147397036724e-131, 7.90895075243694e-130, 0, 0,
    0, 5.35532003199117e-131, 1.18261259880703e-129, 0, 0,
    0, 0, 0, 0.990049833749167, 0,
    0, 0, 0, -0.0497508312541597, 1;
    ss_A[0] = A0;

    matrix<double, NR_OF_STATES, NR_OF_STATES> A1;
    A1 = 1, 0.000157197751595795, 0.000349328336879545, 0, 0,
    0, 3.55223671157049e-88, 1.17220272153963e-86, 0, 0,
    0, 3.54147560806869e-88, 1.16865166460401e-86, 0, 0,
    0, 0, 0, 0.990049833749167, 0,
    0, 0, 0, -0.0331672208361065, 1;
    ss_A[1] = A1;

    matrix<double, NR_OF_STATES, NR_OF_STATES> A2;
    A2 = 1, 0.000209653965071790, 0.000621196933546046, 0, 0,
    0, 1.14063482569650e-66, 4.99218588886101e-65, 0, 0,
    0, 8.53021934523808e-67, 3.73339825199388e-65, 0, 0,
    0, 0, 0, 0.990049833749167, 0,
    0, 0, 0, -0.0248754156270798, 1;
    ss_A[2] = A2;
    ...
    0, -0.00249168745840268, 0.00498337491680535;
    ss_B[0] = B0;

    matrix<double, NR_OF_STATES, NR_OF_CONTROLS> B1;
    B1 = 0.166598362062492, 0, 0,
    1.66724888056147, 0, 0,
    -0.388064085871256, 0, 0,
    0, 0.0995016625083194, -0.199003325016639,
    0, -0.00166112497226845, 0.00332224994453690;
    ss_B[1] = B1;
    ...
    0, 0.0995016625083194, -0.199003325016639,
    0, -0.00124584372920134, 0.00249168745840268;
    ss_B[2] = B2;
}