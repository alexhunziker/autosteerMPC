...
mpc_gps_o.PredictionHorizon = 6;
%% specify control horizon
mpc_gps_o.ControlHorizon = 6;
%% specify nominal values for inputs and outputs
mpc_gps_o.Model.Nominal.U = [0;0;0];
mpc_gps_o.Model.Nominal.Y = [0;0;0;0;0];
%% specify constraints for MV and MV Rate
mpc_gps_o.MV(1).Min = -0.395398163397448;
mpc_gps_o.MV(1).Max = 0.395398163397448;
...
%% specify weights
mpc_gps_o.Weights.MV = [0.1 0.5 0.5];
mpc_gps_o.Weights.MVRate = [0.5 0.2 0.2];
mpc_gps_o.Weights.OV = [2 0 0 1 15];
