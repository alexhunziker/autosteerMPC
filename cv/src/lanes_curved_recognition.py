...
class CurvedLaneRecognizer(object):
    """
    ...
    def process(self, img):
        ...
        hls_channels: list = CurvedLaneRecognizer.convert_to_hls(img)
        sobel = CurvedLaneRecognizer.sobel_edge_detection(hls_channels[1])
