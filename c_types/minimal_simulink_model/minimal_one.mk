###########################################################################
## Makefile generated for Simulink model 'minimal_one'. 
## 
## Makefile     : minimal_one.mk
## Generated on : Sat Aug 03 17:26:33 2019
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/minimal_one.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/alexh/MATLAB/Projects/MINIMA~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = minimal_one_comp.rsp
CMD_FILE                  = minimal_one.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/minimal_one.exe
...
DEFINES_STANDARD = -DMODEL=minimal_one -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/minimal_one_ert_rtw/minimal_one.c

MAIN_SRC = $(START_DIR)/minimal_one_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/minimal_one_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/minimal_one_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
